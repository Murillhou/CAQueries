...
//		CAQuery.printAll(mebn.getDomainResidentNodes());
	// EXECUTE TYPE SEARCH QUERY IN ORDER TO KNOW IF THERE IS A GPSPoasition ENTITY IN THE ONTOLOGY WITH THE SAME COORDINATES SPECIFIED AS ARGUMENTS
		...
		String sol = null;
	// IF THE POSITION EXISTS (THEN gpsPos OV IN MTHEORY REFERS TO THAT ONTOLOGY INDIVIDUAL)
		if(l.size()>0){
			// TODO CONSIDERS THAT THE SOLUTION LIST JUST CARRIES ONE ENTRY WITH THE DESIRED GPSPOSITION(INDEX 0) 
		...
		// ADD ENTITY INSTANCE TO THE FINDINGS FILE:"(ASSERT (GPSPosition_LABEL gpsPos))" 
